            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-list-content">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <img alt="image" src="../../assets/dist/img/avatar/avatar-1.jpeg" class="rounded-circle dropdown-item-img">
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <img alt="image" src="../../assets/dist/img/avatar/avatar-2.jpeg" class="rounded-circle dropdown-item-img">
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <img alt="image" src="../../assets/dist/img/avatar/avatar-3.jpeg" class="rounded-circle dropdown-item-img">
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <img alt="image" src="../../assets/dist/img/avatar/avatar-4.jpeg" class="rounded-circle dropdown-item-img">
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <img alt="image" src="../../assets/dist/img/avatar/avatar-5.jpeg" class="rounded-circle dropdown-item-img">
                  <div class="dropdown-item-desc">
              ...
              <div class="card">
                ...
                <div class="card-body">             
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="../../assets/dist/img/avatar/avatar-1.jpeg" alt="avatar">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="../../assets/dist/img/avatar/avatar-2.jpeg" alt="avatar">
                      <div class="media-body">
                        <div class="float-right"><small>10m</small></div>
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="../../assets/dist/img/avatar/avatar-3.jpeg" alt="avatar">
                      <div class="media-body">
                        <div class="float-right"><small>10m</small></div>
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="../../assets/dist/img/avatar/avatar-4.jpeg" alt="avatar">
                      <div class="media-body">
                        <div class="float-right"><small>10m</small></div>
